...
class Die : public CSGIntersection {
	private:
		Sphere	sphere, one0_, two0_, two1_, three0_, three1_, three2_,
			four0_, four1_, four2_, four3_, five0_, five1_, five2_,
			five3_, five4_, six0_, six1_, six2_, six3_, six4_, six5_;
		Plane plane0, plane1, plane2, plane3, plane4, plane5;
		CSGComplement	one0, two0, two1, three0, three1, three2, four0,
